...
async function example() {
  ...
  const frame3 = hexStringToUint8Array(hexDump1_3);
  const frame4 = hexStringToUint8Array(hexDump1_4);
  const frame5 = hexStringToUint8Array(hexDump1_5);
  const frame6 = hexStringToUint8Array(hexDump1_6);
  const frame7 = hexStringToUint8Array(hexDump1_7);
  const frame8 = hexStringToUint8Array(hexDump1_8);
  const frame9 = hexStringToUint8Array(hexDump1_9);
  ...
  try {
    ...
    const result3 = decompressor.feed(frame3)
    console.log("Compressed size 4:", frame3.length);
    console.log("Decompressed size 4:", result3.decompressedData.length);
    console.log("Consumed bytes 4:", result3.consumed);

    const result4 = decompressor.feed(frame4)
    console.log("Compressed size 5:", frame4.length);
    console.log("Decompressed size 5:", result4.decompressedData.length);
    console.log("Consumed bytes 5:", result4.consumed);

    const result5 = decompressor.feed(frame5)
    console.log("Compressed size 6:", frame5.length);
    console.log("Decompressed size 6:", result5.decompressedData.length);
    console.log("Consumed bytes 6:", result5.consumed);

    const result6 = decompressor.feed(frame6)
    console.log("Compressed size 7:", frame6.length);
    console.log("Decompressed size 7:", result6.decompressedData.length);
    console.log("Consumed bytes 7:", result6.consumed);

    const result7 = decompressor.feed(frame7)
    console.log("Compressed size 8:", frame7.length);
    console.log("Decompressed size 8:", result7.decompressedData.length);
    console.log("Consumed bytes 8:", result7.consumed);

    const result8 = decompressor.feed(frame8)
    console.log("Compressed size 9:", frame8.length);
    console.log("Decompressed size 9:", result8.decompressedData.length);
    console.log("Consumed bytes 9:", result8.consumed);

    const result9 = decompressor.feed(frame9)
    console.log("Compressed size 10:", frame9.length);
    console.log("Decompressed size 10:", result9.decompressedData.length);
    console.log("Consumed bytes 10:", result9.consumed);
  } finally {
    decompressor.destroy();
  }
}
